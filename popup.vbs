...
Else
    WScript.Echo "Hmm, We are still waiting for you to agree to our Terms befor using LFNPro."
    WScript.Quit(1)
End If
...
Else
    ...
    strMessage1 = "Warning: LFNPro Usage" & vbCrLf & vbCrLf & _
                  "Attention: Before proceeding, please carefully review the following information." & vbCrLf & vbCrLf & _
                  "Using the LFN software to optimize your system's performance can yield significant benefits, but it is crucial to understand and acknowledge the potential risks involved." & vbCrLf & vbCrLf & _
    ...
    strMessage2 = vbCrLf & vbCrLf & _
                  ...
                  "5. Prohibited actions: Redistribution or resale of the LFNPro software is strictly prohibited. The software is intended for personal use only and may not be shared, distributed, or sold without explicit permission from the developers." & vbCrLf & vbCrLf & _
                  ...
                  "Exercise diligence, proceed with caution, and enjoy the benefits of optimizing your system's performance with the LFNPro Tweaker." & vbCrLf & vbCrLf & _
                  "Do you accept the terms and conditions?"

    ' Display the agreement message
    intResult = MsgBox(strMessage1, vbOKCancel + vbExclamation, "LFN Warning")
    ' If the user clicks OK, display the second part of the message
    If intResult = vbOK Then
        intResult = MsgBox(strMessage2, vbYesNo + vbExclamation, "LFN Warning")
